...
{
	IMAGEMANAGER->addImage("배경화면", "images/배경.bmp", WINSIZEX * 2, WINSIZEY * 2, true, RGB(255, 0, 255));
	IMAGEMANAGER->addImage("카메라", "images/카메라.bmp", WINSIZEX / 10, WINSIZEY / 10, true, RGB(255, 0, 255));
	IMAGEMANAGER->addImage("미니맵", "images/배경.bmp", WINSIZEX * 2 / 10, WINSIZEY * 2 / 10, true, RGB(255, 0, 255));
