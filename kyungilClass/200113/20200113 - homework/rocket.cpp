...
void rocket::update()
{
	...
	if (KEYMANAGER->isStayKeyDown('Z'))
	{
		...
		if (count % 15 == 0)
		{
			_nuclear->fire(rc.right - (rc.right - rc.left) / 2, rc.top - 50, 5.0f);
			//_nuclear->fire(rc.right - (rc.right - rc.left) / 2 +50, rc.top - 50);
			//_nuclear->fire(rc.right - (rc.right - rc.left) / 2 +100, rc.top - 50);
			//_nuclear->fire(rc.right - (rc.right - rc.left) / 2 +150, rc.top - 50);
			//_nuclear->fire(rc.right - (rc.right - rc.left) / 2 +200, rc.top - 50);
			//_nuclear->fire(rc.right - (rc.right - rc.left) / 2 +250, rc.top - 50);
			//
			//_nuclear->fire(rc.right - (rc.right - rc.left) / 2 - 50, rc.top - 50);
			//_nuclear->fire(rc.right - (rc.right - rc.left) / 2 - 100, rc.top - 50);
			//_nuclear->fire(rc.right - (rc.right - rc.left) / 2 - 150, rc.top - 50);
